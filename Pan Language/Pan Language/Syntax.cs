...
namespace Pan_Language
{
    public static class Syntax
    {
        ...
        private static readonly List<string> KeyWords = new List<string> { "if", "else", "function", "true", "false", "null", "this", "int", "string", "let", "class", "exec", "print", "void", "while", "input", "end" };
